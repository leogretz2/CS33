...
int main(int argc, char **argv)
{
    ...
    double secs, ops, util, avg_mm_util, avg_mm_throughput, perfindex;//, p1, p2;
    int numcorrect;
	...
	perfindex = avg_mm_util*avg_mm_util*avg_mm_util*avg_mm_throughput/135;
	printf("Score = (%.3f [avg util])^3 * (%.3f [avg Kops]) / 135 = %.0f/100\n",
	       avg_mm_util,
	       avg_mm_throughput,
	       //p1*100, 
	       //p2*100, 
